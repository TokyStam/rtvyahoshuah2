...
class MY_Profiler extends CI_Profiler
{
    ...
    {
        $output  = "\n\n";
        $output .= '<fieldset style="border:1px solid #599926;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee">';
        $output .= "\n";

        $output .= '<legend style="color:#489924;">&nbsp;&nbsp;' . 'DONNEES SESSION' . '&nbsp;&nbsp;</legend>';
        $output .= "\n";
...
background-color:#ddd;'>&#36;_SESSION[" . $key . "]&nbsp;&nbsp; </td><td width='50%' style='color:#2e9922;font-weight:normal;background-color:#ddd;'>";
