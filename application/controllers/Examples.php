...
class Examples extends MY_Controller
{
    ...
    {
        $this->is_logged_in();
        echo $this->load->view('theme/en_tete', '', TRUE);
        echo $this->load->view('examples/page_header', '', TRUE);
    ...
    public function create_user()
    {
        ...
        $user_data = [
            'username'   => 'feta',
            'passwd'     => 'Yahoshuah0513',
            'email'      => 'johnnyftr05@gmail.com',
		...
		if( $this->form_validation->run() )
		{
			...
			if( $this->db->affected_rows() == 1 )
				echo '<h1>Felicitation</h1>' . '<p>l\'utilisateur ' . $user_data['username'] . ' est cree.</p>';
		}
		else
		{
			echo '<h1>Erreure de creation</h1>' . validation_errors();
		}
    ...
    public function login()
    {
        ...
        $html = $this->load->view('theme/en_tete', '', TRUE);
